...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2026 at 01:42 PM
...
INSERT INTO `equipment` (`equipment_id`, `name`, `daily_rate`) VALUES
(1, 'GPS Navigation', 200.00),
(2, 'Child Safety Seat', 150.00),
(3, 'Ski Rack', 300.00),
(4, 'Dash Cam', 100.00),
(5, 'GPS Navigation', 200.00),
(6, 'Child Safety Seat', 150.00),
(7, 'Ski Rack', 300.00),
(8, 'Dash Cam', 100.00);
...
INSERT INTO `reservations` (`reservation_id`, `user_id`, `vehicle_id`, `start_date`, `end_date`, `status`, `insurance_added`, `total_cost`, `created_at`) VALUES
(1, 4, 1, '2026-01-20', '2026-01-22', 'Completed', 0, 3000.00, '2026-01-20 00:54:26'),
(2, 4, 1, '2026-01-20', '2026-01-22', 'Cancelled', 0, 3000.00, '2026-01-20 00:59:03'),
(3, 4, 5, '2026-01-22', '2026-01-29', 'Completed', 1, 12250.00, '2026-01-22 02:07:38'),
(4, 4, 2, '2026-01-22', '2026-01-26', 'Active', 0, 10000.00, '2026-01-22 02:24:50');
...
(2, 'Toyota', 'Innova', 2023, 'DEF 5678', 'Van', 'Rented', 2500.00, NULL, '2026-01-20 00:45:12'),
...
--
ALTER TABLE `reservation_equipment`
  ADD CONSTRAINT `reservation_equipment_ibfk_1` FOREIGN KEY (`reservation_id`) REFERENCES `reservations` (`reservation_id`),
